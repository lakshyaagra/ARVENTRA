...
const ArventraAIBubble = () => {
    ...
    return (
        <div className="group fixed bottom-16 right-10 z-50">
            ...
            {!expanded && (
                <div
                    className=" pointer-events-none absolute bottom-16 right-0 mb-3 w-64 origin-bottom-right
                    scale-95 rounded-2xl border border-[#293533] bg-[#171F1E] px-4 py-3 opacity-0
                    shadow-2xl shadow-black/30 transition-all duration-200 ease-out group-hover:pointer-events-auto
            ...
            {expanded && (
                <div
                    className="overflow-hidden rounded-2xl border border-[#293533]
                    bg-[#171F1E] mb-3 shadow-2xl shadow-black/30 w-85"
                >
                    {/* HEADER */}
                    <div
                        className=" flex items-center justify-between border-b border-[#293533] px-4 py-3"
                    >
                        <div>
                    ...
                    <div className="max-h-64 min-h-32 overflow-y-auto px-4 py-4">
                        {latestAssistantMessage ? (
                            <div
                                className=" rounded-xl border border-[#293533] bg-[#121817] p-4
                                "
                            >
                    ...
                    >
                        <div
                            className=" flex items-center gap-2 rounded-xl border border-[#293533] bg-[#121817] p-2
                            "
                        >
                            <input
                                type="text"
                            ...
                            <button
                                ...
                                text-[#0F1716] transition-colors hover:bg-teal-400 disabled:cursor-not-allowed
                                disabled:opacity-40
                                "
                            >
                    ...
                    <button
                        type="button"
                        onClick={() => navigate("/ai")}
                        className="flex w-full items-center justify-center border-t border-[#293533] px-4 py-3
                            text-xs font-medium text-teal-400 transition-colors hover:bg-[#1B2422]
                            hover:text-teal-300
                        "
                    >
                        Open Arventra AI
            ...
            <button
                ...
                transition-all duration-200 hover:scale-105 hover:border-teal-500/50
                hover:bg-[#1B2422] focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500/60"
            >
                {expanded ? (
                    <X className="h-5 w-5" />
                ) : (
