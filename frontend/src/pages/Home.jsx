...
const Home = () => {
  ...
  // Any button whose job is "get the visitor into the app" (login/register)
  // should just take an already-logged-in user straight to their dashboard
      ...
      <header className="fixed top-0 left-0 z-50 w-full border-b border-white/10 bg-[#111817]/40 backdrop-blur-[30px] backdrop-saturate-200">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-9">
          ...
          <nav className="hidden items-center gap-8 text-sm text-slate-400 md:flex">
            <button onClick={() => navigate("/learning")} className="transition hover:text-white">
              Learn
            </button>
            <button onClick={() => navigate("/learning")} className="transition hover:text-white">
              Community
      ...
      <main className="pt-20">
              ...
              <div className="relative">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-4 border-b border-[#293432] pb-5">
                    ...
                    <div>
                      <p className="text-sm font-medium text-slate-200">Learn</p>
                  ...
                  <div className="flex items-center gap-4 border-b border-[#293432] py-5">
                    ...
                    <div>
                      <p className="text-sm font-medium text-slate-200">Manage</p>
                      <p className="mt-1 text-xs text-slate-500">
                  ...
                  <div className="flex items-center gap-4 pt-5">
                    ...
                    <div>
                      <p className="text-sm font-medium text-slate-200">Grow</p>
                      <p className="mt-1 text-xs text-slate-500">
          ...
          <div className="mx-auto max-w-7xl px-6 py-16">
            ...
            <div className="mt-12 grid gap-10 md:grid-cols-3">
              <div className="border-l border-[#33403D] pl-5">
                ...
                <h3 className="mt-3 text-lg font-medium text-slate-100">Learn</h3>
              ...
              <div className="border-l border-[#33403D] pl-5">
                ...
                <h3 className="mt-3 text-lg font-medium text-slate-100">Manage</h3>
                <p className="mt-2 text-sm leading-7 text-slate-400">
                  Keep track of income, expenses, goals, loans, assets, and more.
                </p>
              </div>

              <div className="border-l border-[#33403D] pl-5">
                <span className="text-xs text-slate-600">03</span>
                <h3 className="mt-3 text-lg font-medium text-slate-100">Discuss</h3>
                <p className="mt-2 text-sm leading-7 text-slate-400">
        ...
        <section className="mx-auto max-w-7xl px-6 py-20">
          <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr]">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-[#24302D] bg-[#151D1C] p-6 transition-colors hover:border-teal-700/40">
        ...
        <section className="border-y border-[#26302F] bg-[#141B1A]">
          <div className="mx-auto max-w-7xl px-6 py-20">
            ...
            <div className="-mb-10 mt-12 grid gap-5 lg:grid-cols-[1.85fr_1fr]">
              <div className="rounded-2xl border border-[#24302D] bg-[#151D1C] p-7 transition-colors hover:border-teal-700/40">
                ...
                <div className="mt-8 space-y-3">
                  <div className="rounded-lg border border-[#24302D] bg-[#151D1C] px-5 py-4 transition-colors hover:border-teal-700/40">
        ...
        <section className="mx-auto max-w-7xl px-6 py-20">
          <div className="border-t border-[#293432] pt-12">
            ...
            <div className="mt-4 flex flex-col justify-between gap-8 md:flex-row md:items-end">
              ...
              >
                {isAuthenticated ? "Go to Dashboard →" : "Start with Arventra →"}
              </button>
            </div>
          </div>
        </section>
      ...
      <footer className="border-t border-[#26302F]">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-8 text-sm text-slate-500 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex gap-6">
            <button onClick={() => navigate("/learning")} className="hover:text-slate-300">
              Learn
            </button>
            <button onClick={() => navigate("/learning")} className="hover:text-slate-300">
              Community
            </button>
            <button onClick={() => navigate("/calculators")} className="hover:text-slate-300">
              Calculators
            </button>
            <button onClick={() => navigate("/contact")} className="hover:text-slate-300">
              Contact
            </button>
            <button onClick={() => goToAppOr("/login")} className="hover:text-slate-300">
